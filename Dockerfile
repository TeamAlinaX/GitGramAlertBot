...
RUN git clone https://github.com/TeamAlinaX/GitGramAlertBot -b pyrogram /root/git_alert_core.py
RUN mkdir /root/GitGramAlertBot/bin/
WORKDIR /root/GitGramAlertBot/
RUN chmod +x /usr/local/bin/*
RUN pip3 install -r requirements.txt
CMD ["python","git_alert_core.py"]
